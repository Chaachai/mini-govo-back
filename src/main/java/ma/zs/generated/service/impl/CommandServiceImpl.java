...
public class CommandServiceImpl implements CommandService {
	...
	public Command save(Command command) {
		...
		if (command.getClient() != null) {
			...
			if (client == null) {
				...
				User updatedClient = userService.updateAddressAndPhone(command.getClient());
				command.setClient(updatedClient);
			}
		}
	...
	public List<Command> findByCriteria(CommandVo commandVo) {
		...
		query += SearchUtil.addConstraintMinMax("o", "longitudeDelivery", commandVo.getLongitudeDeliveryMin(),
				commandVo.getLongitudeDeliveryMax());
		query += SearchUtil.addConstraintMinMaxDate("o", "commentResolutionDate ",
				commandVo.getCommentResolutionDateMin(), commandVo.getCommentResolutionDateMax());
		query += SearchUtil.addConstraintMinMaxDate("o", "dateSubmission", commandVo.getDateSubmissionMin(),
				commandVo.getDateSubmissionMax());
		query += SearchUtil.addConstraintMinMax("o", "nbrTotalComment", commandVo.getNbrTotalCommentMin(),
				commandVo.getNbrTotalCommentMax());
		query += SearchUtil.addConstraintMinMax("o", "yearCommand", commandVo.getYearCommandMin(),
				commandVo.getYearCommandMax());
		query += SearchUtil.addConstraintMinMax("o", "latitudeDelivery", commandVo.getLatitudeDeliveryMin(),
				commandVo.getLatitudeDeliveryMax());
		query += SearchUtil.addConstraintMinMaxDate("o", "orderDate", commandVo.getOrderDateMin(),
				commandVo.getOrderDateMax());
		query += SearchUtil.addConstraintMinMax("o", "dayCommand", commandVo.getDayCommandMin(),
				commandVo.getDayCommandMax());
		query += SearchUtil.addConstraintMinMax("o", "monthCommand", commandVo.getMonthCommandMin(),
				commandVo.getMonthCommandMax());
